...
namespace Data
{
    public class SqlDBDataAccess
    {
        ...
        public void gemIOffentligDataBase(int ekgmaaleid, DateTime dato, int antalmaalinger, string sfp_ansvfornavn, string sfp_ansvefternavn, int sfp_ansvmedarbjnr, string sfp_ans_org, string sfp_anskommentar, string borger_fornavn, string borger_efternavn, string borger_cprnr)
        {
            ...
            string insertStringParam = @"INSERT INTO dbo.EKGDATA ( dato, antalmaalinger, sfp_ansvfornavn, sfp_ansvefternavn, sfp_ansvrmedarbjnr, sfp_ans_org, sfp_anskommentar, borger_fornavn, borger_efternavn, borger_cprnr) 
        ...
        public void gemIOffentligDBEKGDATA(string raa_data, double samplerate_hz, int interval_sec, double interval_min, string data_format, string bin_eller_tekst, string maaleformat_type, DateTime start_tid, string kommentar, int ekgmaaleid, string maaleenhed_identifikation)
        {
            ...
            using (SqlCommand cmdOff = new SqlCommand(insertStringParam, connectionOff))
            {
                cmdOff.Parameters.AddWithValue("@raa_data", raa_data);
                cmdOff.Parameters.AddWithValue("@samplerate_hz", samplerate_hz);
                cmdOff.Parameters.AddWithValue("@interval_sec", interval_sec);
                cmdOff.Parameters.AddWithValue("@interval_min", interval_min);
                cmdOff.Parameters.AddWithValue("@data_format", data_format);
                cmdOff.Parameters.AddWithValue("@bin_eller_tekst", bin_eller_tekst);
                cmdOff.Parameters.AddWithValue("@maaleformat_type", maaleformat_type);
                cmdOff.Parameters.AddWithValue("@start_tid", start_tid);
                cmdOff.Parameters.AddWithValue("@kommentar", kommentar);
                cmdOff.Parameters.AddWithValue("@ekgmaaleid", ekgmaaleid);
                cmdOff.Parameters.AddWithValue("@maaleenhed_identifikation", maaleenhed_identifikation);
                cmdOff.ExecuteReader();
            }
